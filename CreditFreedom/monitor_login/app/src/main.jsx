...
function CredentialCard({ card, index, onEdit, onDelete, showPasswords }) {
  ...
  const details = [
    { label: 'URL', value: card.URL || '-', copyValue: card.URL || '' },
    ...
    { label: 'Last Import', value: card.Last_Import || '-', copyValue: card.Last_Import || '' },
    { label: 'Import Status', value: card.Import_Status || '-', copyValue: card.Import_Status || '' },
