  ...
  function ToggleSwitch({ checked, disabled, onChange }) {
    return /* @__PURE__ */ React.createElement(
      "button",
      {
        ...
        className: `relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${checked ? "bg-indigo-700" : "bg-gray-300"} ${disabled ? "opacity-60 cursor-not-allowed" : ""}`
      },
  ...
  function AlertcontrolPanelCard() {
    ...
    useEffect(() => {
      ZOHO.embeddedApp.on("PageLoad", (data) => {
        ...
        setLoading(true);
        setError(null);
        ZOHO.CRM.API.getRecord({ Entity: "Contacts", RecordID: id }).then((res) => {
        ...
        }).catch(() => setError("Failed to load alert settings.")).finally(() => setLoading(false));
      });
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl border border-gray-200 shadow-sm px-5 pt-5 pb-4" }, /* @__PURE__ */ React.createElement("h2", { className: "text-base font-bold text-gray-900 mb-4" }, "Alert Control Panel"), error && /* @__PURE__ */ React.createElement("div", { className: "mb-4 rounded-lg border border-red-200 bg-red-50 px-3 py-2" }, /* @__PURE__ */ React.createElement("p", { className: "text-xs text-red-600" }, error)), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-3" }, FIELD_DEFS.map((field) => /* @__PURE__ */ React.createElement("div", { key: field.api, className: "bg-gray-100 rounded-xl px-4 py-4 flex items-center justify-between gap-4" }, /* @__PURE__ */ React.createElement("span", { className: "text-sm font-medium text-gray-700" }, field.label), /* @__PURE__ */ React.createElement(
      ToggleSwitch,
      {
